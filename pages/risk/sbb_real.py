...
graph_std = dbc.Col(dcc.Graph(id=name + "fig1"), md=6)
graph_log = dbc.Col(dcc.Graph(id=name + "fig2"), md=6)
graph_box = dbc.Col(dcc.Graph(id=name + "fig3"), md=6)
...
tbl = dbc.Col(tbl, md=6)

row1 = dbc.Row([slider])
row2 = dbc.Row([tbl, graph_box], align="top")
row3 = dbc.Row([graph_std, graph_log], align="center")
