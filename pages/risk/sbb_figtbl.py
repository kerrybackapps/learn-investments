...
def figtbl(name, dates):
    ...
    corr = rets[["S&P 500", "Gold", "Corporates", "Treasuries"]].corr()
    ...
    return [smallfig(fig, showlegend=True) for fig in [fig1, fig2, fig3]] + [tbl.to_dict('records'), corr.to_dict('records')]
