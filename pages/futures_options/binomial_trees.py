...
col1 = dbc.Col([drop, slider5], xs=12, sm=6, md=4, lg=4, className="mb-2")
col2 = dbc.Col([slider1, slider2], xs=12, sm=6, md=4, lg=4, className="mb-2")
col3 = dbc.Col([slider3, slider4], xs=12, sm=6, md=4, lg=4, className="mb-2")
row1 = dbc.Row([col1, col2, col3], align="center", className="gx-1")

col1 = dbc.Col(graph1, xs=12, sm=12, md=6, lg=6, className="mb-2")
col2 = dbc.Col(graph2, xs=12, sm=12, md=6, lg=6, className="mb-2")
row2 = dbc.Row([col1, col2], align="center", className="gx-1")
