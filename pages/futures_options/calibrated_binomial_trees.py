...
col1 = dbc.Col([drop, html.Br(), slider7], md=3)
col2 = dbc.Col([slider1, slider2], md=3)
col3 = dbc.Col([slider3, slider4], md=3)
col4 = dbc.Col([slider5, slider6], md=3)
row1 = dbc.Row([col1, col2, col3, col4], align="center")

left = dbc.Col(graph1, md=6)
right = dbc.Col(graph2, md=6)
