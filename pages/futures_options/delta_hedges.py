...
col3 = dbc.Col(slider6, xs=12, sm=12, md=4, lg=4, className="mb-2")  # Underlying price
...
col1 = dbc.Col([label_call_delta, label_call_cash], xs=12, sm=6, md=3, lg=3, className="mb-2")
col2 = dbc.Col([call_delta, call_cash], xs=12, sm=6, md=3, lg=3, className="mb-2")
col3 = dbc.Col([label_put_delta, label_put_cash], xs=12, sm=6, md=3, lg=3, className="mb-2")
col4 = dbc.Col([put_delta, put_cash], xs=12, sm=6, md=3, lg=3, className="mb-2")
row3 = dbc.Row([col1, col2, col3, col4], align="center", className="gx-1")


col1 = dbc.Col(graph1, xs=12, sm=12, md=6, lg=6, className="mb-2")
col2 = dbc.Col(graph2, xs=12, sm=12, md=6, lg=6, className="mb-2")
row4 = dbc.Row([col1, col2], align="center", className="gx-1")
